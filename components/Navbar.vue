<template>
  <nav
    class="fixed z-10 w-full bg-white dark:bg-transparent md:absolute md:bg-transparent"
  >
    <div class="container m-auto px-2 md:px-12 lg:px-7">
      <div
        class="flex items-center justify-between py-3 gap-6 md:py-4 md:gap-0"
      >
        <div class="w-full px-6 z-30">
        ...
        <div class="w-full flex items-center justify-center">
          <nuxt-link to="./collection" class="relative px-6 py-2 rounded-lg group">
            <span
              class="absolute inset-0 w-full h-full transition duration-300 transform -translate-x-1 -translate-y-1 bg-yellow-500 ease opacity-80 group-hover:translate-x-0 group-hover:translate-y-0"
            ></span>
            <span
              class="absolute inset-0 w-full h-full transition duration-300 transform translate-x-1 translate-y-1 bg-blue-500 ease opacity-80 group-hover:translate-x-0 group-hover:translate-y-0 mix-blend-screen"
            ></span>
            <span
              class="relative text-2xl font-bold text-blue-500 police transition group-hover:text-yellow-200"
              >Check our collection</span
            >
          </nuxt-link>
        </div>
        <div
