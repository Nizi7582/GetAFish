    ...
    <div class="container mx-auto py-32">
      <div class="flex shadow-md bg-gray-100">
        <div class="w-3/4 bg-white px-10 py-10">
          ...
          <div
            v-for="fish in fishs" :key="fish.id"
          ...
          >
            <div class="flex w-2/5">
              ...
              <div class="flex flex-col justify-between ml-4 flex-grow">
                <span class="font-bold text-xl">{{ fish.name }}</span>
                <a
                  href="#"
            ...
            <span class="text-center w-1/5 font-semibold text-sm">{{ fish.price }} €</span>
          </div>
        ...
        <div id="summary" class="w-1/4 px-8 py-10">
          ...
          <div class="flex justify-between mt-10 mb-5">
            <span class="font-semibold text-sm uppercase"
              >Number of species</span
            >
            <span class="font-semibold text-sm">1</span>
          </div>
          <div class="flex justify-between mt-10 mb-5">
            <span class="font-semibold text-sm uppercase">Number of fish</span>
            <span class="font-semibold text-sm">1</span>
          </div>
